...
* [Get Code 🌍](https://github.com/taehyung77/DirextX-Example/tree/15)
...
### 잠깐 복습... Component에 관하여

```cpp
// Component는 Object에 의해 상속되며
...
private:
    // GameObject는 Component를 배열로 갖고있는다
...
// 자신이 관리중인 Component를 돌며 함수를 호출해주는 일을 한다.
...
GameObject를 추가해 주는 부분

```cpp
// 예를들어 Camera와 Sphere를 생성하다면
