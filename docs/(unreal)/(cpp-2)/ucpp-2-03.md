...
* [Get Code 🌎](https://github.com/Arthur880708/Unreal_Cpp_Basic_2/tree/3)

## Pawn

* Actor를 상속받은 특수한 Actor이며,
* 주로 Player가 빙의해 입출력을 처리하도록 설계된다.
* Pawn의 Component는 Collision Component가 Root이고 이외 Visual, Movement 등이 있다.

---

### 실습해보기 - BlueSprint로 Pawn만들기

* 이번엔 직접만들진 말고 BP_ThirdPersonCharacter를 사용해보자

<p align="center">
  <img src="https://taehyungs-programming-blog.github.io/blog/assets/images/unreal/unreal_cpp_2/ucpp_2_3_1.png"/>
</p>

* BP_ThirdPersonCharacter는 Pawn은 아니지만 Charater를 상속한다.

<p align="center">
  <img src="https://taehyungs-programming-blog.github.io/blog/assets/images/unreal/unreal_cpp_2/ucpp_2_3_2.png"/>
</p>

* Collision이 Root Component이고
* Charaterer Movement가 달려있음을 확인하자

---

### 실습해보기 - C++로 Pawn만들기

* 기존에 생성된 ABCharacter를 사용한다
...
AABGameMode::AABGameMode()
{
    ...
    // ABCharacterPlayer로 DefaultPawnClass를 설정
...
### AABCharacterPlayer 만들기

* 우선 Camera가 어떻게 붙나 보자
...
AABCharacterPlayer::AABCharacterPlayer()
{
	...
	FollowCamera->SetupAttachment(CameraBoom, USpringArmComponent::SocketName/*SpringArm 끝에 붙여달란 말.*/);
...
// ArenaBattle.Build.cs에 EnhancedInput 추가해줘야함 아니면 아래처럼 써야한다.
