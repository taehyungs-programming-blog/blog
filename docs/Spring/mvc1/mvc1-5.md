...
* [Clone Code 🌎](https://github.com/EasyCoding-7/spring-mvc1/tree/7)

## 우선 index.html을 조금 수정한다.
...
## JSP는 Java코드를 아래와 같이 표현할 수 있다.

- jsp의 경우 - <%@ ~ %> - import
- <% ~~ %> - java code 입력
- <%= ~~ %> - java code 출력

## JSP를 위해서 gradle을 조금 수정하자
